...
(68,'bo','bol',N'Болівія'),
(535,'bq','bes',N'Бонайре, Сінт-Естатіус і Саба'),
...
(334,'hm','hmd',N'Острови Герд і Макдональд'),
(184,'ck','cok',N'Острови Кука'),
(586,'pk','pak',N'Пакистан'),
(585,'pw','plw',N'Палау'),
(275,'ps','pse',N'Палестинська автономія'),
(591,'pa','pan',N'Панама'),
(598,'pg','png',N'Папуа Нова Гвінея'),
(600,'py','pry',N'Парагвай'),
(604,'pe','per',N'Перу'),
(710,'za','zaf',N'ПАР'),
(239,'gs','sgs',N'Південна Джорджія і Південні Сандвічеві Острови'),
