...
(16,'as','asm',N'Ameriška Samoa'),
(40,'at','aut',N'Avstrija'),
(36,'au','aus',N'Avstralija'),
(533,'aw','abw',N'Aruba'),
(248,'ax','ala',N'Ålandski otoki'),
...
(535,'bq','bes',N'Bonaire, Sveti Evstahij, Saba'),
...
(246,'fi','fin',N'Finska'),
(242,'fj','fji',N'Fidži'),
(238,'fk','flk',N'Falklandi'),
(583,'fm','fsm',N'Mikronezija'),
(234,'fo','fro',N'Ferski otoki'),
...
(254,'gf','guf',N'Francoska Gvajana'),
...
(300,'gr','grc',N'Grčija'),
(239,'gs','sgs',N'Južna Georgia in Južni Sandwichevi otoki'),
...
(334,'hm','hmd',N'Heardov otok in McDonaldovo otočje'),
...
(356,'in','ind',N'Indija'),
(86,'io','iot',N'Britanski teritorij v Indijskem oceanu'),
(368,'iq','irq',N'Irak'),
(364,'ir','irn',N'Iran'),
...
(663,'mf','maf',N'Sveti Martin (francoski del)'),
...
(446,'mo','mac',N'Macao'),
(580,'mp','mnp',N'Severni Marianski otoki'),
...
(744,'sj','sjm',N'Svalbard in Jan Mayen'),
...
(534,'sx','sxm',N'Nizozemski Sveti Martin'),
(222,'sv','slv',N'Salvador'),
(760,'sy','syr',N'Sirija'),
(796,'tc','tca',N'Otoki Turks in Caicos'),
(148,'td','tcd',N'Čad'),
(260,'tf','atf',N'Francoska južna ozemlja'),
(768,'tg','tgo',N'Togo'),
(764,'th','tha',N'Tajska'),
...
(800,'ug','uga',N'Uganda'),
(581,'um','umi',N'Manjši zunanji otoki ZDA'),
...
(92,'vg','vgb',N'Britanski Deviški otoki'),
(850,'vi','vir',N'Ameriški Deviški otoki'),
(704,'vn','vnm',N'Vietnam'),
(548,'vu','vut',N'Vanuatu'),
(876,'wf','wlf',N'Wallis in Futuna'),
